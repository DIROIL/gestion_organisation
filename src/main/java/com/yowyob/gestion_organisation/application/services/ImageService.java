...
import com.yowyob.gestion_organisation.infrastructure.persistence.repository.ImageRepository;
...
public class ImageService {
    ...
    public List<ImageDto> getImageByRessource(String  idOrganisation) {
        return imageRepository.findByIdOrganisation(idOrganisation).stream()
    ...
    public ImageDto uploadImage(MultipartFile file, String idOrganisation) {
