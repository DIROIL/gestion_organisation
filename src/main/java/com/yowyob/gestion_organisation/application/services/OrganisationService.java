...
public class OrganisationService {
    ...
    public OrganisationResponse createOrganisation(OrganisationRequest request , UUID domainKey) {
        com.yowyob.gestion_organisation.domain.model.Organisation organisation = OrganisationFactory.create(request ,domainKey );
    ...
    public List<OrganisationResponse> getAllOrganisations(UUID domainKey) {
        return organisationRepository.findByDomainKey(domainKey).stream().map(this::organisationToOrganisationResponse).toList();
    }
