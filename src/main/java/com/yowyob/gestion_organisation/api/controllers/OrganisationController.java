...
public class OrganisationController {
    ...
    @PostMapping("/create")
    public OrganisationResponse postMethodName(@RequestBody OrganisationRequest request, @RequestParam("domainKey" ) UUID domainKey) {
        return organisationService.createOrganisation(request, domainKey);
    }

    
    @Operation(summary = "Lister toute les Agences d'une Organisation", description = "")
    ...
    public List<OrganisationResponse> getAllOrganisation(@RequestParam("domainKey" ) UUID domainKey) {
        return organisationService.getAllOrganisations(domainKey);
    }
