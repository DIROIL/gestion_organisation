...
public class OpenAPIConfig {
  ...
  public OpenAPI myOpenAPI() {
    ...
    Info info = new Info()
        .title("API de gestion des Organisation")
        .version("1.0")
        .contact(contact)
        .description("Cet API est un endpoint pour la gestion des Organisation.").termsOfService("http://localhost:4000/ressources")
        .license(mitLicense);
